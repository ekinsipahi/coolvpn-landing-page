"""Chat-log preservation (VPNsterr assistant).
...
whole conversation, a cascaded user/account deletion, or the anonymous-conversation
cron purge. The archive holds no foreign keys, so nothing cascades it away: the
customer↔operator transcript survives even when the conversation is deleted.
